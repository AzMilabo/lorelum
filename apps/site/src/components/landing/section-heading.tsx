    ...
    <Reveal className="mx-auto max-w-3xl text-center">
      {eyebrow ? (
        <p className="inline-flex items-center rounded-full border border-fd-border/60 bg-fd-card/50 px-3.5 py-1 backdrop-blur">
          <span className="bg-gradient-to-r from-indigo-400 via-violet-400 to-cyan-400 bg-clip-text font-display text-[11px] font-semibold uppercase tracking-[0.22em] text-transparent">
            {eyebrow}
          </span>
        </p>
      ) : null}
